...
CREATE TABLE IF NOT EXISTS player_in_team (
    ...
    player_offer_id  CHAR(36) NULL DEFAULT NULL,    -- Referenz auf das angenommene Direktangebot (Kauf per /player_offer)
    ...
    FOREIGN KEY (player_offer_id) REFERENCES player_offer(id),
