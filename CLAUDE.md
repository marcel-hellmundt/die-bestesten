...
POST     /h2h_prediction    {match_id, pick:'home'|'draw'|'away'} — Tipp setzen/ändern (Upsert, beliebig oft bis Anpfiff); 404 wenn Match nicht gefunden, 403 wenn Anpfiff der zugehörigen Matchday bereits erfolgt ist oder die Matchday nicht die aktuelle ist (kleinste noch nicht abgeschlossene number in Saison+Division) — Auth
