...
POST     /h2h/draw_semifinals    {league_id, season_id} → {matches:4} — Legt 4 Halbfinale (Hin+Rück) aus VF-Siegern (Aggregat-Gesamttore) an (Bed.: Spieltag 27 abgeschlossen, noch keine SFs vorhanden); VF1:VF2@MD29, VF3:VF4@MD30 (Hin), VF2:VF1@MD31, VF4:VF3@MD32 (Rück); sendet Notification an alle Manager — Admin
POST     /h2h/draw_final         {league_id, season_id} → {matches:1} — Legt Finale aus HF-Siegern (Aggregat-Gesamttore) an (Bed.: Spieltag 32 abgeschlossen, noch kein Final vorhanden); HF1:HF2@MD34 — Admin
