            ...
            new Route('sticker', 'Sticker', [
                ...
                'endpoints' => [
                    [
                        ...
                        'description' => 'Album der aktiven Saison: alle Spieler, die am Stichtag 1.9. (Startjahr der Saison) laut player_in_club bei einem Verein der 1. Bundesliga (level=1, country=DE) waren → {season_id, cutoff_date, matchdays:[{number,kickoff_date}], clubs:[{id,name,short_name,logo_uploaded,primary_color,secondary_color,players:[{id,displayname,first_name,last_name,position,price,photo_uploaded}]}]}; clubs nach Vorsaison-Tabellenplatz (wie /noten), players nach Position, dann price absteigend; jeder Spieler genau einmal (bei überlappenden Vereins-Stints am Stichtag zählt der jüngste); nur Spieler mit Foto (player_in_season.photo_uploaded der Bundesliga-Zeile) — ohne Foto kein Sticker; price = player_in_season.price der Bundesliga-Zeile, null wenn fehlend oder Platzhalter > 50 Mio (POST /player/create_manual); matchdays = alle Spieltage der Saison in der 1. Bundesliga (Zeitachse der Simulation) — Maintainer+',
                    ],
                ],
            ]),
