            ...
            new Route('player', 'Player', [
                ...
                'endpoints' => [
                    ...
                    [
                        'method' => 'POST',
                        'path' => '/player/create',
                        'description' => 'Erstellt einen neuen Spieler mit Saison- und optional Club-Zuweisung — gibt {id, displayname} zurück; displayname ist meist identisch zum übergebenen Wert, weicht aber ab, wenn dieser (z.B. CSV-Kurzname, oft nur der Nachname) bereits vergeben ist: automatischer Ausweich-Name "1. Buchstabe Vorname + Nachname" (z.B. "J. Gomez"), 409 wenn selbst dieser Ausweichname schon existiert; 400 wenn price außerhalb 0 < price <= 50.000.000 — Maintainer+',
                        'body' => [
