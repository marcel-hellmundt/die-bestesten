...
{
    public static array $methodRoles = ['GET' => 'manager', 'POST' => ['contributor', 'maintainer'], 'PATCH' => ['contributor', 'maintainer']];
    ...
    protected function get(): mixed
    {
        ...
        if ($this->id === 'best_xi') {
            ...
            return $this->db->getBestXi($matchdayId, $freeAgentsOnly);
        }
