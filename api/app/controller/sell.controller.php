...
class SellController extends _BaseController
{
    ...
    protected function post(): mixed
    {
        ...
        if (!$this->db->isPlayerActiveInTeam($teamId, $playerId)) {
            http_response_code(404);
            return ['status' => false, 'message' => 'Player not in team'];
        }

        $result = $this->db->sellPlayer($teamId, $playerId, $windowId);
        return ['status' => true, 'sell_id' => $result['sell_id'], 'price' => $result['price']];
    }
